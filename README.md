...
기능적 요구사항
1. 사용자가 오디오북을 예약한다.
1. 예약한 오디오북에 대해서 결제한다.
1. 결제 후 사용승인이 되면 오디오북을 대여한다.
1. 오디오북이 대여가 되면 재고가 감소된다.
1. 사용자가 오디오북 예약을 취소한다.
1. 예약을 취소하면 결제가 취소된다.
1. 사용자가 오디오북를 반납한다.
...
![image](https://user-images.githubusercontent.com/31404198/125188546-267e7100-e26f-11eb-9cd8-674365a4e5ce.png)
    ...
    - 사용자가 오디오북 선택 후 예약한다. (ok)
    - 예약한 오디오북에 대해서 결제한다. (ok)
    - 결제 후 사용승인이 되면 오디오북을 대여한다. (ok)
    - 오디오북이 대여가 되면 재고가 감소된다. (ok)

![image](https://user-images.githubusercontent.com/31404198/125188569-35652380-e26f-11eb-9d41-cd6e23a87959.png)

    - 사용자가 오디오북 예약을 취소한다. (ok)
